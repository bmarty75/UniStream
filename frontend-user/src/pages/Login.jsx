...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4">
      <div className="mb-8">
        <h1 className="text-green-500 font-black text-4xl tracking-tighter uppercase">UNIFLIX</h1>
      </div>
      <div className="bg-gray-900 p-8 rounded-lg border border-gray-800 w-full max-w-md">
        ...
        {apiError && (
          <div className="bg-red-900/50 border border-green-500 text-red-300 px-4 py-3 rounded mb-4 text-sm">
            {apiError}
          </div>
        )}
